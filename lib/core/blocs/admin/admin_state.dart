...
class AdminUsersLoaded extends AdminState {
  ...
  final int page;
  final int pages;
  const AdminUsersLoaded({required this.users, required this.total, required this.page, required this.pages});
  @override List<Object?> get props => [users, total, page];
}
...
class AdminLoansLoaded extends AdminState {
  ...
  @override List<Object?> get props => [loans, total];
}
...
class AdminChitsLoaded extends AdminState {
  ...
  @override List<Object?> get props => [chits, total];
}
