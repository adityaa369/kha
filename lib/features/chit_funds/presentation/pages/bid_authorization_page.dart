    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _InfoRow(label: 'Branch Name', value: 'KPHB-CAO'),
          SizedBox(height: 12.h),
          _InfoRow(label: 'Chit Number', value: 'KKPT47J-26'),
          SizedBox(height: 12.h),
          _InfoRow(label: 'Auction Date', value: '21-Jun-2025'),
          SizedBox(height: 12.h),
          _InfoRow(label: 'Chit Value', value: '₹ 5,00,000'),
          SizedBox(height: 24.h),
          SizedBox(
            width: 140.w,
            height: 44.h,
