                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _buildRow(
                            'Amount:',
                            '₹ ${currencyFmt.format((state as dynamic).amountRupees ?? 0)}',
                            true,
                          ),
                          const SizedBox(height: 12),
                          _buildRow(
                            'Intent ID:',
                            state.intentId.length > 8
                                ? state.intentId.substring(0, 8)
                                : state.intentId,
                            false,
                          ),
                        ],
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          onPressed: () =>
                              context.read<AddCreditFlowCubit>().rejectIntent(),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: highlight ? KhaataTheme.primaryBlue : Colors.black87,
          ),
        ),
      ],
    );
