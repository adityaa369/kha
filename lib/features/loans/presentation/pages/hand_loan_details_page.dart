          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(Icons.handshake_outlined, size: 14.sp, color: _primary),
                SizedBox(width: 6.w),
                Text('Hand Credit', style: TextStyle(color: _primary, fontSize: 12.sp, fontWeight: FontWeight.w700)),
              ]),
            ),
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              SizedBox(width: 12.w),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(isPdf ? 'Signed_Agreement_Hand_Credit.pdf' : 'Proof_Document_Hand_Credit.jpg',
