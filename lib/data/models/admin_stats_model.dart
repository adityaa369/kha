class AdminStats {
  ...
  factory AdminStats.fromJson(Map<String, dynamic> json) => AdminStats(
    ...
    totalLoanVolume: (json['totalLoanVolumePaise'] != null
        ? json['totalLoanVolumePaise'] / 100.0
        : (json['totalLoanVolume'] ?? 0).toDouble()),
    totalChitVolume: (json['totalChitVolumePaise'] != null
        ? json['totalChitVolumePaise'] / 100.0
        : (json['totalChitVolume'] ?? 0).toDouble()),
